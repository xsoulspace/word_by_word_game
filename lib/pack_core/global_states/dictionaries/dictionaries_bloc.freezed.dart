...
/// Adds pattern-matching-related methods to [DictionariesBlocState].
extension DictionariesBlocStatePatterns on DictionariesBlocState {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _DictionariesBlocState value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _DictionariesBlocState() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _DictionariesBlocState value)  $default,){
final _that = this;
switch (_that) {
case _DictionariesBlocState():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _DictionariesBlocState value)?  $default,){
final _that = this;
switch (_that) {
case _DictionariesBlocState() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( WordsType wordsType)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DictionariesBlocState() when $default != null:
return $default(_that.wordsType);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( WordsType wordsType)  $default,) {final _that = this;
switch (_that) {
case _DictionariesBlocState():
return $default(_that.wordsType);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( WordsType wordsType)?  $default,) {final _that = this;
switch (_that) {
case _DictionariesBlocState() when $default != null:
return $default(_that.wordsType);case _:
  return null;
