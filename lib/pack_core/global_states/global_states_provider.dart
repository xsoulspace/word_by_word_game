...
class GlobalStatesProvider extends StatelessWidget {
  ...
  Widget build(final BuildContext context) => MultiProvider(
    providers: [
      ...
      Provider<LevelsRepository>.value(value: Di.get()),
      Provider<GameRespository>.value(value: Di.get()),
      Provider(create: WordsRespository.new),
      Provider<AppSettingsRepository>.value(value: Di.get()),
      ...
      ChangeNotifierProvider<AppSettingsResource>.value(value: Di.get()),
    ],
