...
/// Adds pattern-matching-related methods to [LevelRouteArgs].
extension LevelRouteArgsPatterns on LevelRouteArgs {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _LevelRouteArgs value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _LevelRouteArgs() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _LevelRouteArgs value)  $default,){
final _that = this;
switch (_that) {
case _LevelRouteArgs():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _LevelRouteArgs value)?  $default,){
final _that = this;
switch (_that) {
case _LevelRouteArgs() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String levelId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LevelRouteArgs() when $default != null:
return $default(_that.levelId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String levelId)  $default,) {final _that = this;
switch (_that) {
case _LevelRouteArgs():
return $default(_that.levelId);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String levelId)?  $default,) {final _that = this;
switch (_that) {
case _LevelRouteArgs() when $default != null:
return $default(_that.levelId);case _:
  return null;
